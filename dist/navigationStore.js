...
_this2.dispatch(_reactNavigation.NavigationActions.navigate({routeName:'RightDrawerOpen'}));
};this.

rightDrawerClose=function(){
_this2.dispatch(_reactNavigation.NavigationActions.navigate({routeName:'RightDrawerClose'}));
};this.
